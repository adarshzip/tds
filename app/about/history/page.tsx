        ...
        <main className="">
            <div className="bg-white ">
                <div className="max-w-6xl mx-auto px-10 flex text-gray-500 text-sm py-5 gap-1">
                    ...
                    <FontAwesomeIcon icon={faArrowRight} className="my-auto"/>
                    <Link href="/about/history" className="text-usc-red underline">Team History</Link>
                </div>
                ...
                <div className="py-5 mx-auto max-w-6xl basis-full text-black px-10">
                    ...
                    <div className="flex flex-col gap-5">
                        <div className="flex flex-col gap-3 pt-1">
                            ...
                            <p>The Trojans have been a cornerstone of the National Debate Tournament since it began in 1947 when Potter Kerfoot and George Grover finished second at the inaugural tournament. The following year, Kerfoot also won the first ever Top Speaker award. The Trojans have maintained a standard of excellence at the NDT earning <Link href="/about/ndtspeakers" className="text-usc-red underline">individual speaker awards</Link> as well as team performances. Trojans hold records for the longest continual streak of qualification (having qualified for every year since 1963) and for qualifying in the most seasons of any university. We recognize the <Link href="/about/NDTHistory" className="text-usc-red underline">full list of every Trojan who has qualified for the NDT</Link>.</p>
