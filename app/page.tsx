    ...
    <main className="bg-white">
      ...
      <div className="bg-white py-5 px-6 flex flex-col gap-6 mx-auto max-w-6xl">
        <div className="flex flex-col">
          <a href="/about" className="text-usc-red text-2xl underline">About the Team</a>
        ...
        <div className="flex flex-col">
          <a href='/prospects' className="text-usc-red text-2xl underline">Join Us</a>
        ...
        <div className="flex flex-col">
          <a href="/outreach" className="text-usc-red text-2xl underline">Outreach</a>
          <p className="text-black">Learn about our efforts to expand access to debate throughout Los Angeles.</p>
        </div>
        <div className="flex flex-col">
          <a href="/donate" className="text-usc-red text-2xl underline">Donate</a>
        ...
        <div className="flex flex-col">
          <a href='/contact' className="text-usc-red text-2xl underline">Contact</a>
